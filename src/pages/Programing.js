const Programing = () => {
    return (
        <>
            ...
            <ul>
                <li>Github</li>
                <a href="https://marklodato.github.io/visual-git-guide/index-en.html" 
                target="_blank" rel="noreferrer noopener">
                    A Visual Git Reference</a>
                    
                <li>Package manager official site</li>
                <a href="https://yarnpkg.com/getting-started" 
                target="_blank" rel="noreferrer noopener">yarnpkg</a><br/>

                <a href="https://nodejs.org/en/download" 
                target="_blank" rel="noreferrer noopener">nodejs download and installation</a>

                <li>React Official Site</li>
                <a href="https://create-react-app.dev/" 
                target="_blank" rel="noreferrer noopener">Official documents</a>
            </ul>
            ...
            <ul>
                ...
                <li>Follow the official guide</li>
                    <a href="https://create-react-app.dev/docs/deployment/#github-pages" 
                    target="_blank" rel="noreferrer noopener">
                ...
                <li>Solutions for client-side routing</li>
                    <p>
                        1.Switch to hashHistory.(Not recommended)<br/>
                        <a href="https://reactrouter.com/en/main/routers/create-hash-router"
                         target="_blank" rel="noreferrer noopener">
                        createHashRouter</a><br/>
                        2.Redirecting to your index.html page with a custom redirect parameter.<br/>
                        <a href="https://github.com/rafgraph/spa-github-pages#single-page-apps-for-github-pages" 
                        target="_blank" rel="noreferrer noopener">
